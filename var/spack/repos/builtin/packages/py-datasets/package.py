...
class PyDatasets(PythonPackage):
    ...
    version("2.18.0", sha256="cdf8b8c6abf7316377ba4f49f9589a4c74556d6b481afd0abd2284f3d69185cb")
    ...
    depends_on("py-filelock", type=("build", "run"), when="@2.9.0:")
    ...
    depends_on("py-pyarrow@12:+parquet", type=("build", "run"), when="@2.9.0:")
    depends_on("py-dill@0.3.0:0.3.9", type=("build", "run"))
    ...
    depends_on("py-huggingface-hub@0.21.2:", type=("build", "run"), when="@2.18.0:")
    depends_on("py-huggingface-hub@0.2:0", type=("build", "run"), when="@2.8.0:2.9.0")
    ...
    depends_on("py-fsspec@2024.2.0:+http", type=("build", "run"), when="@2.18.0:")
